      ...
      {/* Logo */}
          <div className="relative top-[-65px] gap-240 flex max-md:flex-col">
            ...
            <img
               ...
               alt="Company logo"
               className="object-contain mt-10 max-w-full aspect-[2.41] w-[150px] max-md:mt-10 ml-[-10px]"
             />
            </div>
            <div className="ml-5 w-max-md:ml-0 max-md:w-full">
               <img
                 ...
                 alt="Healthcare icon"
                 className="object-contain mt-10 max-w-full aspect-[2.41] w-[200px] max-md:mt-10 ml-[-10px]0 "
               />
            </div>
         </div>
